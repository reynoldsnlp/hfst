...
print_usage()
{
    ...
    fprintf(message_out,
            ...
            "concatenates cat.hfst with dog.hfst and writes results to "
            "catdog.hfst\n"
            "\n",
            program_name);
    print_report_bugs();
...
parse_options(int argc, char **argv)
{
    ...
    while (true)
    {
        ...
        int option_index = 0;
        int c = getopt_long(
            argc, argv, HFST_GETOPT_COMMON_SHORT HFST_GETOPT_BINARY_SHORT "FH",
...
int
concatenate_streams(HfstInputStream &firststream,
                    HfstInputStream &secondstream)
{
