...
// All programs
void
print_common_program_options(FILE *file)
{
...
//   weighted2unweighted
void
print_common_unary_program_options(FILE *file)
{
...
void
print_common_unary_program_parameter_instructions(FILE *file)
{

    fprintf(file, "If OUTFILE or INFILE is missing or -, standard streams "
                  "will be used.\n"
...
//   disjunct,
void
print_common_binary_program_options(FILE *file)
{
    ...
    fprintf(
        ...
        "  -C, --do-not-convert   Do not allow transducers to be converted "
        "into the same type\n"
        "  -o, --output=OUTFILE   Write results to OUTFILE\n");
}

void
print_common_binary_program_parameter_instructions(FILE *file)
{
    ...
    fprintf(
        ...
        "each transducer in INFILE1 keeping the second transducer "
        "constant.\n");
}
