...
//        "  -o, --output=FILENAME      Write output transducer(s) to
//        FILENAME\n" "  -R, --symbols=FILENAME     Read symbol table from
//        FILENAME\n" "  -D, --do-not-write-symbols         Do not write symbol
//        table with the output transducer(s)\n" "  -W,
//        --write-symbols-to=FILENAME    Write symbol table to file FILENAME\n"
...
#define HFST_GETOPT_BINARY_LONG                                               \
    { "input1", required_argument, 0, '1' },                                  \
        { "input2", required_argument, 0, '1' },                              \
        { "output", required_argument, 0, 'o' },                              \
        { "do-not-convert", no_argument, 0, 'C' }

// Write separate commandline helps: compare, split, strings2fst, summarize,
// txt2fst
