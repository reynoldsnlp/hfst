...
void lookup_fd_and_print(HfstIterableTransducer &t, HfstOneLevelPaths& results,
...
// HERE
HfstOneLevelPaths*
lookup_simple(const HfstOneLevelPath& s, HfstIterableTransducer& t, bool* infinity)
{
